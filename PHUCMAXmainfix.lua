-- PHUCMAX | SETTINGS + AUTORUN | CLEAN
...
-- Keep autorun lightweight: write only a loader, not another full copy of the script.
if type(writefile) == "function" then
    pcall(function()
        writefile("PHUCMAX_RESUME.lua", [[
local path = "PHUCMAXmainfix_autotreadmill_CLEAN.lua"
...
for key, value in pairs({
    ...
    ["Auto Treadmill"] = "Tự chạy máy chạy",
    ["Auto Upgrade Treadmill"] = "Tự nâng cấp máy chạy",
    ["Auto Steal Eggs"] = "Tự động cướp trứng",
    ["Anti Egg Drop "] = "Chống rơi trứng",
    ["Rare Egg Hunter (Highest Rarity First)"] = "Ưu tiên trứng độ hiếm cao",
    ["Filter by Rarity (Multi-Select)"] = "Lọc theo độ hiếm",
    ["Filter by Area (Multi-Select)"] = "Lọc theo khu vực",
    ["Filter by Mutation (Multi-Select)"] = "Lọc theo đột biến",
    ["Glide / Travel Speed"] = "Tốc độ bay / di chuyển",
    ...
    ["Steal Best Available Egg Once"] = "Cướp trứng tốt nhất một lần",
    ["Auto Hatch Ready Eggs"] = "Tự nở trứng đã sẵn sàng",
    ["Auto Place Egg (Base Pen)"] = "Tự đặt trứng vào chuồng",
    ["Hatch Check Delay"] = "Độ trễ kiểm tra trứng",
    ["Hatch All Ready Eggs Now"] = "Nở tất cả trứng sẵn sàng",
    ["Place Carried Eggs in Pen Now"] = "Đặt trứng đang mang vào chuồng",
    ["Egg ESP Enabled"] = "Bật ESP trứng",
    ["Show 3D Pet Image Badges"] = "Hiện ảnh pet 3D",
    ["Trap ESP (Highlights Enemy Traps)"] = "ESP bẫy đối thủ",
    ["Show Mutated / Rare Eggs Only"] = "Chỉ hiện trứng hiếm / đột biến",
    ["Max ESP Distance"] = "Khoảng cách ESP tối đa",
    ["Auto Upgrade Base / Plot"] = "Tự nâng cấp nhà / plot",
    ["Auto Upgrade Treadmill Tier"] = "Tự nâng cấp cấp máy chạy",
    ["Auto Buy Speed Trails"] = "Tự mua vệt tốc độ",
    ["Upgrade Base Now"] = "Nâng cấp nhà ngay",
    ["Upgrade Treadmill Now"] = "Nâng cấp máy chạy ngay",
    ["Equip Best Pets Now"] = "Trang bị pet tốt nhất",
    ["Auto Sell Low-Tier Pets"] = "Tự bán pet cấp thấp",
    ["Filter Pet Sell Rarities"] = "Lọc độ hiếm pet bán",
    ["Auto Sell Low-Tier Eggs"] = "Tự bán trứng cấp thấp",
    ["Filter Egg Sell Rarities"] = "Lọc độ hiếm trứng bán",
    ["Sell Selected Pets Now"] = "Bán pet đã chọn",
    ["Sell Selected Eggs Now"] = "Bán trứng đã chọn",
    ["FULL AUTO Boss Fight (Join + Fight + Dodge + Claim)"] = "Tự động đánh Boss (vào + đánh + né + nhận)",
    ["Boss Targeting"] = "Chọn mục tiêu Boss",
    ["Hazard Immunity (No Black Hole / Trap Damage)"] = "Miễn sát thương nguy hiểm",
    ["Auto Join Boss Arena (Every 30 min)"] = "Tự vào khu Boss mỗi 30 phút",
    ["Auto Claim Boss Mastery Rewards"] = "Tự nhận thưởng thành thạo Boss",
    ["Join Boss Arena Now"] = "Vào khu Boss ngay",
    ["Claim Boss Mastery Now"] = "Nhận thưởng Boss ngay",
    ["Boss Arena Status"] = "Trạng thái khu Boss",
    ["Auto Claim Away Earnings & Codex"] = "Tự nhận thu nhập ngoại tuyến và Codex",
    ["Claim Away Earnings & Codex Now"] = "Nhận thu nhập ngoại tuyến và Codex",
    ["Bat / Slap Aura"] = "Aura gậy / tát",
    ["Aura Radius"] = "Bán kính Aura",
    ["Swing Delay"] = "Độ trễ vung gậy",
    ["Swing Bat Once (Manual)"] = "Vung gậy một lần",
    ["Anti-Trap (Full Immunity / Destroy Hitboxes)"] = "Chống bẫy (miễn nhiễm / phá hitbox)",
    ["No Knockback / Ragdoll Immunity"] = "Không bị đẩy / miễn ragdoll",
    ["Anti-Ragdoll (Quick Standup)"] = "Chống ragdoll (đứng dậy nhanh)",
    ["Enable WalkSpeed"] = "Bật tốc độ chạy",
    ["WalkSpeed Value"] = "Giá trị tốc độ chạy",
    ["Infinite Jump"] = "Nhảy vô hạn",
    ["Anti-AFK (Bypass 20min Kick)"] = "Chống AFK (không bị kick 20 phút)",
    ["Select Area"] = "Chọn khu vực",
    ["Travel to Selected Area"] = "Đi tới khu vực đã chọn",
    ["Select Plot"] = "Chọn plot",
    ["Travel to Plot"] = "Đi tới plot",
    ...
    ["Refresh Player List"] = "Làm mới danh sách người chơi",
    ["Travel to Player"] = "Đi tới người chơi",
    ["Fullbright (Daylight Visuals)"] = "Sáng toàn màn hình",
    ["Ride Light Dark Guard (Real Movement)"] = "Cưỡi Light Dark Guard (di chuyển thật)",
    ["Delete Own Pet Renders (FPS Boost)"] = "Xóa model pet của mình (tăng FPS)",
    ["Shop"] = "Cửa hàng",
    ["Event"] = "Sự kiện",
    ["Settings"] = "Cài đặt",
    ["Auto Steal"] = "Tự cướp trứng",
    ["Auto Hatch & Plant"] = "Tự nở và đặt trứng",
    ["Egg Tracker ESP"] = "ESP theo dõi trứng",
    ["Homestead & Treadmill"] = "Nhà và máy chạy",
    ["Pets & Satchel"] = "Pet và túi đồ",
    ["Auto Sell"] = "Tự bán",
    ["Events & Bosses"] = "Sự kiện và Boss",
    ["Claim Rewards"] = "Nhận thưởng",
    ["Bat & Slap Aura"] = "Aura gậy và tát",
    ["Defense & Guards"] = "Phòng thủ và lính gác",
    ["Movement"] = "Di chuyển",
    ["Area Travel"] = "Di chuyển khu vực",
    ["Plot Travel"] = "Di chuyển plot",
    ["Player Travel"] = "Di chuyển tới người chơi",
    ["Visuals & Performance"] = "Hiển thị và hiệu năng",
    ["Trail Shop"] = "Cửa hàng vệt tốc độ",
    ["Speed & Trail"] = "Tốc độ và vệt",
    ["Drone"] = "Drone",
}) do
...
local function PHUCMAX_NOTIFY(title, content, dur)
    -- Tắt thông báo hệ thống của PHUCMAX.
    return
end
...
local function Notify(title, content, kind, dur)
    -- Đã tắt toàn bộ popup/thông báo để giảm lag.
    return
end
            ...
            if tool.Parent == character then
                ...
                if spot then
                    ...
                    elseif EggState and EggState.PlantEgg then
                        -- Fallback to the game's own client EggState wrapper.
...
hatchReadyEggs=function(force,...)
    ...
    local ok, err = pcall(function()
        ...
        for uid, record in pairs(records) do
            ...
            if ready then
                -- Same fast sequence as the working reference:
                -- skip growth -> begin hatch -> finish hatch.
...
-- Boss/Event combat engine removed in v9.
...
function HUB.GuardRide.Start()
        ...
        for _, obj in ipairs(guardAreas:GetDescendants()) do
            if obj.Name == "Guard" then
                ...
                if model and model:IsA("Model") and not seen[model] then
                    ...
                    local areaName = area.Name ~= "GuardAreas" and area.Name or obj.Parent and obj.Parent.Name or "Khu vực"
    ...
    if not source or not source:IsA("Model") then
        Notify("Cưỡi", "Không tìm thấy Guard đã chọn", "Error", 4)
        return false
    end
    ...
    if not character or not realHumanoid or not realRoot then
        Notify("Cưỡi", "Nhân vật chưa sẵn sàng", "Error", 3)
        return false
    end
    ...
    Notify("Cưỡi", "Đã cưỡi Guard - giữ animation đứng/chạy đầy đủ", "Success", 4)
    return true
end
...
-- AUTO TREADMILL
-- Rule:
--   * Auto Steal ON  -> Auto Treadmill is forced OFF.
--   * Auto Steal OFF -> Auto Treadmill is automatically ON.
--   * Search only the player's own plot.
--   * Prefer the plot's known TreadmillBottom, then treadmill/seat models.
--   * Never treat an arbitrary Model inside the plot as a treadmill.

local autoTreadmillUserEnabled = true
...
local function findMyAutoTreadmill()
    -- v6: mirror the working reference's treadmill cache logic.
    -- The reference does NOT require the object itself to be named
    -- "Treadmill"; it scans the player's plot, Treadmills/Stands folders,
    -- then chooses the nearest valid Model/BasePart.
    local st = state
    ...
    if not plot or typeof(plot) ~= "Instance" or not plot.Parent then
        ...
        -- Same primary ownership resolution as the working reference.
        local slot = nil
        pcall(function()
            if PlotState and PlotState.ResolveLocalSlot then
    ...
    -- First use the canonical part saved by findPlayerPlot().
    ...
    -- Reference implementation: collect both Models and named treadmill parts.
    ...
    -- Exactly the useful search order from the working source.
    ...
    -- Match the reference's scoring: Models get a +40 bias, then nearest wins.
    ...
    for _, candidate in ipairs(candidates) do
        ...
        if pos then
            ...
            -- Strongly prefer explicit treadmill/belt objects when available.
            if name:find("treadmill", 1, true) then score += 100000 end
            if name == "treadmillbottom" then score += 200000 end

            -- A candidate with a Seat is much more likely to be the machine.
...
findAutoTreadmillSeat = function(treadmill)
    ...
    -- In some plot layouts TreadmillBottom and the Seat are siblings.
...
local function runAutoTreadmill()
    ...
    local ok, result, reason = pcall(function()
        ...
        if not treadmill then
            return false, "Không tìm thấy TreadmillBottom trong plot"
        end
        ...
        if not root or not humanoid or humanoid.Health <= 0 then
            return false, "Không tìm thấy nhân vật/Humanoid"
        end
        ...
        if seat then
            ...
            if distance > 10 and not flyToAutoTreadmill(seat.Position) then
                return false, "Không di chuyển tới treadmill được"
            end

            if not sitOnMyAutoTreadmill(treadmill) then
                return false, "Không thể vào Seat treadmill"
            end

            upgradeAutoTreadmill()
            return true, "Đã vào treadmill"
        end
        ...
        if not beltPosition then
            return false, "Treadmill không có vị trí hợp lệ"
        end
        ...
        if (root.Position - target).Magnitude > 10 then
            if not flyToAutoTreadmill(target) then
                return false, "Không di chuyển tới TreadmillBottom được"
            end
        end

        -- No Seat: keep the Humanoid on the belt and move along its facing
        -- direction, matching the working reference's belt-walking behavior.
        local beltCF = nil
        pcall(function()
        ...
        upgradeAutoTreadmill()
        return true, "Đã đứng/chạy trên TreadmillBottom"
    end)

    autoTreadmillBusy = false

    if not ok then
        -- Do not flood the screen every 0.35s if the game/executor briefly
        -- invalidates an Instance or shared state.
...
-- Auto Treadmill is automatically enabled whenever Auto Steal is OFF.
local lastTreadmillActiveState = autoTreadmillEnabled
local function syncAutoTreadmillWithAutoSteal()
    local nextState = autoTreadmillUserEnabled and not autoStealEnabled
...
-- AUTO TREADMILL UI (final active window)
-- The file contains a second UI bootstrap; this block mounts the feature
-- into the final/visible "Trứng" tab so it cannot disappear behind the
-- duplicated window.
HUB.UI.TreadmillSub = HUB.UI.EggsTab:AddSubTab("Tự chạy máy")
HUB.UI.TreadmillSub:AddToggle({
    ...
    Callback = safeCallback(function(v)
        ...
        autoTreadmillEnabled = autoTreadmillUserEnabled and not autoStealEnabled
...
HUB.UI.StealSub:AddToggle({
    ...
    Callback = safeCallback(function(v)
        ...
        if v then
            ...
            cancelImportedSteal()
            autoTreadmillEnabled = autoTreadmillUserEnabled
        end
    end)
})
...
local function flyToAbyssOceanGuard()
    ...
    -- Use the hub's existing real-character flight/path routine.
...
HUB.BuildPlayerExtrasUI = function()
    ...
    local function GetGuardRideList()
        ...
        if #list == 0 then list = {"Không tìm thấy Guard"} end
        return list
    end

    local guardRideDropdown = PerfSub:AddDropdown({
        Name = "Chọn Guard để cưỡi", Options = GetGuardRideList(), Items = GetGuardRideList(),
        Default = HUB.GuardRide.selectedGuardKey, Flag = "guard_ride_target",
        Callback = function(v)
            if v ~= "Không tìm thấy Guard" then
    ...
    PerfSub:AddToggle({
        Name = "Cưỡi", Default = false, Flag = "guard_ride_visual",
        Callback = safeCallback(function(v)
            if v then
                HUB.GuardRide.Start()
            else
...
do
    ...
    local EventsSub = HUB.UI.BaseTab:AddSubTab("Sự kiện")

EventsSub:AddButton({
    Name = "Bay đến khu sự kiện ", Primary = true,
    Callback = safeCallback(function()
...
-- Anti-Hit nút trong tab Trứng — dùng chung HUB.UI.StealSub của PHUCMAX.
do
    ...
    -- Gắn toggle vào tab Trứng > sub-tab Auto Steal
    local function Attach()
        ...
        HUB.UI.StealSub:AddToggle({
            ...
            Callback = safeCallback(function(v)
                ANTI.SetEnabled(v)
                Notify("Anti Hit", v and "Đã bật - chain teleport khi cướp" or "Đã tắt", v and "Success" or "Error")
            end)
        })
        return true
    end
