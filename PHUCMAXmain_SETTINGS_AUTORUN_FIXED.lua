...
HUB.UI.EggsTab = Window:AddTab({ Name = "Trứng", Subtitle = "", Icon = "home" })
HUB.UI.BaseTab = Window:AddTab({ Name = "Nhà", Subtitle = "", Icon = "home" })
HUB.UI.CombatTab = Window:AddTab({ Name = "Chiến đấu", Subtitle = "", Icon = "combat" })
HUB.UI.PlayerTab = Window:AddTab({ Name = "Người chơi", Subtitle = "", Icon = "player" })
...
HUB.UI.StealSub:AddToggle({Name = "Bảo vệ trứng 50 studs", Default = false,
...
HUB.UI.MoveSub:AddToggle({
    ...
    Callback = safeCallback(function(v)
        ...
        if hum then
            ...
            if not v and not HUB.Runtime.phucMovementBusy() then hum.WalkSpeed = originalWalkSpeed or 16 end
        end
...
do
    ...
    HUB.BuildDroneUI = function()
        ...
        droneSub:AddToggle({Name = "Drone 10/10 → 5/5 → 3/3", Default = false,
...
function HUB.SetEnabled(value)
    ...
    if shouldPause then
        ...
        if walkSpeedEnabled then
            pcall(function()
                local hum = findHum()
                if hum and not HUB.Runtime.phucMovementBusy() then hum.WalkSpeed = originalWalkSpeed or 16 end
            end)
        end
        pcall(stopFly)
